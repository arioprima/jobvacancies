...
const Footer = () => {
    return (
        <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-2 lg:max-w-[95%]">
            <div className="grid grid-cols-2  sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                <div className="col-span-full mb-5 lg:col-span-2 lg:mb-0">
                    <a href="https://jobvacancies.me/">
                        <img src={Logo} alt="logo" className="w-48 mx-auto" />
                    </a>
                    <div className="lg: px-6">
                        <p className="py-6 text-sm text-gray-500 text-center">
                            We are dedicated to providing you with the best support. If you
                            have any questions, we’re here to assist you!{' '}
                        </p>
                        <a
                            href="javascript:;"
                            className="py-2.5 px-5 h-9 block w-fit bg-indigo-600 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-auto"
                        >
                            Get in touch
                        </a>
                    </div>
                ...
                <div className="lg:mx-auto  pl-6  lg:pl-0 text-left">
            ...
            <div className="py-7 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span className="text-sm text-gray-500 ">
                        ©<a href="https://pagedone.io/">jobvacancies</a>{' '}
